<?php
 ...
 $requete="select *from abonnesarchiver where idemp=$idEmp";
...
<html lang="fr">
  <head>
    ...
    <title>Modifier Abonnes Archivés</title>
...
<meta name="theme-color" content="#7952b3">
  ...
  <div class="inscform">
     ...
     <form class="" id="" name="" method="post" action="modificationabonnearchives.php">
    ...
    <div class="row">
     ...
     <div class="row">
      <div class="form-group col-12">
              <label>salle</label>
            <input type="text" name="dep" class="form-control" placeholder="salle" value="<?php echo $salleU?>">   
         </div>
     <div class="form-group col-12">
